...
.. note::
  MySQL and PostgreSQL have limitations regarding indexes length. So, if the names
  of your columns are too long you can pass the name keyword argument to specify your own index name:
